...
根据主办方提供的 **“特别说明”**，使用一般 RAG 中除 “LLM 答案生成及之后部分” 的流程作为 pipeline（参考下图蓝框）。
...
- 这里只是一种使用 LLM 的思路，并且存在犯规风险，大家还是**重点探索 ① ② ④** 或是将 LLM/一些公开模型 用在其他地方。至于微调 LLM ，个人认为不需要。
